  ...
  <div class="jumbotron">
   <fieldset>
      <a href="user_list_view.php">ユーザー一覧に戻る</a>
          ...
          <label>パスワード<input type="password" name="lpw" placeholder="パスワードを入力してください"></label><br>
<!--      ラジオボタンのデータ取得-->
       <label>
        <?php
        $kanri = $res["kanri_flg"];
...
//EOTは左寄せに！ヒアドキュメント
      ...
      <!--      ラジオボタンのデータ取得-->
       <label>
        ...
        echo <<< EOT
        <input class="radio" type="radio" name="life_flg" value=1 $checked1 />利用中　
        <input class="radio" type="radio" name="life_flg" value=0 $checked0 />退会済み　
EOT;
//EOTは左寄せに！ヒアドキュメント
        ?>
      </label><br>
